...
export default async function handler(req, res) {
  ...
  try {
    ...
    const completionHtml = (recipientName) => `
      <div style="font-family: monospace; max-width: 600px; margin: 0 auto; padding: 40px; background: #0a0906; color: #d4c5a8;">
        ...
        <p style="font-size: 11px; color: #6b6050;">
          Please retain this email as your record of execution. 
          A full copy of the document is accessible at any time.
        </p>
    ...
    await Promise.all([
      ...
      resend.emails.send({
        from: 'ARCODIC <sow@yourdomain.com>',
        to: 'you@arcodic.com', // ← replace with your email
