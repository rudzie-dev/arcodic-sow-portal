...
export default function Dashboard() {
  ...
  useEffect(() => {
    const t = setInterval(() => { load(); setTick(n => n + 1); }, 15000);
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .db-root {
          min-height: 100vh; background: #0a0906;
        ...
        .db-nav {
          ...
          background: rgba(10,9,6,0.92); backdrop-filter: blur(20px);
        ...
        .db-logo {
          ...
          font-size: 20px; font-weight: 700; color: #f0e8d8;
        ...
        .db-refresh-btn {
          ...
          color: #6b6050; padding: 7px 14px; cursor: pointer;
          font-family: 'DM Mono', monospace; font-size: 10px;
        ...
        .db-stats {
          ...
          gap: 1px; background: #1a1610;
          border-bottom: 1px solid #1a1610;
          animation: fadeUp 0.4s 0.05s ease both;
        }
        .db-stat {
          background: #0a0906; padding: 28px 40px;
        ...
        .db-stat-num {
          font-family: 'Cormorant Garamond', serif;
          font-size: 40px; font-weight: 700; color: #f0e8d8; line-height: 1;
        }
        ...
        .db-search-icon {
          ...
          font-size: 11px; color: #4a4035; pointer-events: none;
        }
        .db-search {
          width: 100%; background: #0e0c09; border: 1px solid #1e1a15;
          color: #d4c5a8; font-family: 'DM Mono', monospace; font-size: 11px;
          padding: 9px 12px 9px 32px; outline: none; transition: border-color 0.2s;
        }
        ...
        .db-thead th {
          padding: 12px 40px; text-align: left;
          font-size: 9px; letter-spacing: 0.18em; text-transform: uppercase;
          color: #3a3028; font-weight: 400; white-space: nowrap;
          border-bottom: 1px solid #1a1610; background: #0a0906;
          position: sticky; top: 56px;
        }
        .db-thead th:first-child { padding-left: 40px; }
        .db-row {
          border-bottom: 1px solid #111008; cursor: pointer;
          transition: background 0.15s;
        }
        .db-row:hover { background: #0e0c09; }
        .db-row:hover .db-row-action { opacity: 1; }
        .db-td {
          padding: 18px 24px; vertical-align: middle;
          font-size: 11px; color: #8a7d6b;
          white-space: nowrap;
        }
        ...
        .db-status {
          ...
          padding: 4px 10px; font-size: 9px; letter-spacing: 0.14em;
        ...
        .db-amount {
          font-family: 'Cormorant Garamond', serif;
          font-size: 16px; font-weight: 600; color: #c9a96e;
        }
        ...
        .db-act-btn {
          background: transparent; border: 1px solid #2a2520;
          color: #6b6050; padding: 5px 12px; cursor: pointer;
        ...
        .db-empty {
          ...
          justify-content: center; padding: 120px 40px; gap: 16px;
          color: #3a3028;
        }
        .db-empty-icon { font-size: 32px; opacity: 0.4; }
        .db-empty-title {
          font-family: 'Cormorant Garamond', serif;
          font-size: 24px; color: #4a4035;
        }
        ...
        .db-skel {
          ...
          background: linear-gradient(90deg, #111008 25%, #181410 50%, #111008 75%);
        ...
        /* FOOTER */
        .db-footer {
          padding: 20px 40px; border-top: 1px solid #111008;
          display: flex; align-items: center; justify-content: space-between;
        }
      ...
      <div className="db-root">
        ...
        <div className="db-stats">
          {[
            ...
            <div
              key={s.key}
              className={`db-stat ${filter === s.key ? `active active-${s.key}` : ''}`}
          ...
          {error ? (
              ...
              <tbody>
                {[...Array(5)].map((_, i) => (
                  <tr key={i} className="db-row">
                    {[260, 180, 120, 80, 100, 80].map((w, j) => (
                      <td key={j} className="db-td">
                        <div className="db-skel" style={{ width: w }} />
                      </td>
                    ))}
                  </tr>
                ))}
            ...
            <div className="db-empty">
              ...
              <div className="db-empty-sub">
                {search ? 'Try a different search' : 'Create your first SOW to get started'}
              </div>
            </div>
          ) : (
            <table className="db-table">
              ...
              <tbody>
                {filtered.map((sow, idx) => {
                  ...
                  return (
                    ...
                    >
                      <td className="db-td">
                        <div className="db-project-title">
                          {sow.data?.project?.title || 'Untitled Project'}
                        </div>
                        <div className="db-project-sub">
                          {fmt(sow.created_at)}
                        </div>
                      </td>
                      <td className="db-td">
                      ...
                      <td className="db-td">
                        ...
                        >
                          <div
                            className={`db-status-dot ${st.pulse ? 'pulse' : ''}`}
        ...
        <div className="db-footer">
          ...
          <div className="db-footer-right">Auto-refreshes every 15s</div>
        </div>
      </div>
    </>
  );
